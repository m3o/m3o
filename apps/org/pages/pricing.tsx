  ...
  return (
    <>
      ...
      <MainLayout>
        <PageHeader
          title="Pricing"
          subTitle="Simple, straight forward pricing"
        />
        <div className="m3o-container pt-8">
          ...
          <div className="my-10">
            <p className="mb-4">
              Requests to services are charged at 0.000001 credit per request or in
        ...
        <section className="bg-zinc-50 min-h-screen pb-6 dark:bg-zinc-900">
          <div className="m3o-container pt-6">
            <div className="bg-white rounded-md p-6 border border-zinc-300 border-solid dark:bg-zinc-800 dark:border-zinc-600">
              ...
              <p className="mb-4">
                Services below are charged above the base request pricing
              </p>
              {prices.map(price => (
