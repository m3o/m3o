...
import (
	...
	clitoken "m3o.dev/platform/cli/token"
	"m3o.dev/platform/cli/util"
	"m3o.dev/platform/profile"
	...
	configCli "m3o.dev/platform/service/config/client"
	storeConf "m3o.dev/platform/service/config/store"
	"m3o.dev/platform/service/errors"
	"m3o.dev/platform/service/events"
	"m3o.dev/platform/service/logger"
	"m3o.dev/platform/service/metrics"
	"m3o.dev/platform/service/network"
	"m3o.dev/platform/service/registry"
	"m3o.dev/platform/service/router"
	"m3o.dev/platform/service/runtime"
	"m3o.dev/platform/service/server"
	"m3o.dev/platform/service/store"
	uconf "m3o.dev/platform/util/config"
	"m3o.dev/platform/util/helper"
	"m3o.dev/platform/util/user"
	"m3o.dev/platform/util/wrapper"

	muruntime "m3o.dev/platform/service/runtime"

	authSrv "m3o.dev/platform/service/auth/client"
	brokerSrv "m3o.dev/platform/service/broker/client"
	grpcCli "m3o.dev/platform/service/client/grpc"
	eventsSrv "m3o.dev/platform/service/events/client"
	noopMet "m3o.dev/platform/service/metrics/noop"
	mucpNet "m3o.dev/platform/service/network/mucp"
	registrySrv "m3o.dev/platform/service/registry/client"
	routerSrv "m3o.dev/platform/service/router/client"
	runtimeSrv "m3o.dev/platform/service/runtime/client"
	grpcSvr "m3o.dev/platform/service/server/grpc"
	storeSrv "m3o.dev/platform/service/store/client"
)
