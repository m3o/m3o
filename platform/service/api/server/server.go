...
import (
	...
	pb "m3o.dev/platform/proto/api"
	"m3o.dev/platform/service"
	"m3o.dev/platform/service/api"
	"m3o.dev/platform/service/api/auth"
	"m3o.dev/platform/service/api/handler"
	aapi "m3o.dev/platform/service/api/handler/api"
	"m3o.dev/platform/service/api/handler/event"
	ahttp "m3o.dev/platform/service/api/handler/http"
	"m3o.dev/platform/service/api/handler/rpc"
	"m3o.dev/platform/service/api/handler/web"
	"m3o.dev/platform/service/api/resolver"
	"m3o.dev/platform/service/api/resolver/grpc"
	"m3o.dev/platform/service/api/resolver/host"
	"m3o.dev/platform/service/api/resolver/path"
	"m3o.dev/platform/service/api/resolver/subdomain"
	"m3o.dev/platform/service/api/router"
	regRouter "m3o.dev/platform/service/api/router/registry"
	httpapi "m3o.dev/platform/service/api/server/http"
