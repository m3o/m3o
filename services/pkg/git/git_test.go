...
func TestCheckout(t *testing.T) {
	tcs := []struct {
		...
		{name: "github-latest", repo: "https://m3o.dev/services", branchOrCommit: "latest", remoteBranch: "latest", callCount: 1},
		{name: "github-master", repo: "https://m3o.dev/services", branchOrCommit: "latest", remoteBranch: "master", callCount: 3},
		{name: "github-main", repo: "https://m3o.dev/services", branchOrCommit: "latest", remoteBranch: "main", callCount: 4},
		{name: "github-error", repo: "https://m3o.dev/services", branchOrCommit: "latest", remoteBranch: "someotherdefault", errMatcher: HaveOccurred(), callCount: 5},
		{name: "github-specific", repo: "https://m3o.dev/services", branchOrCommit: "mybranch", remoteBranch: "mybranch", callCount: 1},
		{name: "github-specific-error", repo: "https://m3o.dev/services", branchOrCommit: "mybranch", remoteBranch: "main", errMatcher: HaveOccurred(), callCount: 1},
