...
import (
	...
	"m3o.dev/tools/protoc-gen-m3o/generator"
...
func init() {
	generator.RegisterPlugin(new(m3o))
}

// m3o is an implementation of the Go protocol buffer compiler's
// plugin architecture.  It generates bindings for go-m3o support.
type m3o struct {
	gen *generator.Generator
}

// Name returns the name of this plugin, "m3o".
func (g *m3o) Name() string {
	return "m3o"
}
...
func (g *m3o) Init(gen *generator.Generator) {
	g.gen = gen
...
func (g *m3o) objectNamed(name string) generator.Object {
	g.gen.RecordTypeUse(name)
	return g.gen.ObjectNamed(name)
}

// Given a type name defined in a .proto, return its name as we will print it.
func (g *m3o) typeName(str string) string {
	return g.gen.TypeName(g.objectNamed(str))
}

// P forwards to g.gen.P.
func (g *m3o) P(args ...interface{}) { g.gen.P(args...) }

// Generate generates code for the services in the given file.
func (g *m3o) Generate(file *generator.FileDescriptor) {
...
func (g *m3o) GenerateImports(file *generator.FileDescriptor, imports map[generator.GoImportPath]generator.GoPackageName) {
	if len(file.FileDescriptorProto.Service) == 0 {
		return
	}
	g.P("import (")
...
func (g *m3o) generateService(file *generator.FileDescriptor, service *pb.ServiceDescriptorProto, index int) {
...
func (g *m3o) generateEndpoint(servName string, method *pb.MethodDescriptorProto) {
	if method.Options == nil || !proto.HasExtension(method.Options, options.E_Http) {
		return
	}
	// http rules
...
func (g *m3o) generateClientSignature(servName string, method *pb.MethodDescriptorProto) string {
...
func (g *m3o) generateClientMethod(reqServ, servName, serviceDescVar string, method *pb.MethodDescriptorProto, descExpr string) {
...
func (g *m3o) generateServerSignature(servName string, method *pb.MethodDescriptorProto) string {
	origMethName := method.GetName()
	methName := generator.CamelCase(origMethName)
	if reservedClientName[methName] {
		methName += "_"
...
func (g *m3o) generateServerMethod(servName string, method *pb.MethodDescriptorProto) string {
	methName := generator.CamelCase(method.GetName())
