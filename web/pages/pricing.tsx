      ...
      <MainLayout>
        ...
        <div className="m3o-container pt-8 dark:bg-zinc-900">
          ...
          */}
          ...
          <div className="my-10">
            <p className="mb-4">
              M3O uses an API credit model. Requests are billed from credit on account. Top-up via credit card to get started. 
              Base requests are charged at 0.000001 USD per request aka $1 per million requests.
